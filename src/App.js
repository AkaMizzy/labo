  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path="/presentation_generale"
          element={<Presentation_Generale />}
        />
        ...
        <Route
          path="/journees_scientifique"
          element={<Journees_scientifique />}
        />
        ...
        <Route
          path="/echelle_internationale"
          element={<Echelle_internationale />}
        />
